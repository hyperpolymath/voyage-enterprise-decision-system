...
// Replace voyage-enterprise-decision-system, Voyage Enterprise Decision System — See README.adoc for details., just run, Voyage Enterprise Decision System started successfully. with actuals
= voyage-enterprise-decision-system — Quick Start for Users
:toc:
:toclevels: 2

== What is voyage-enterprise-decision-system?

Voyage Enterprise Decision System — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./voyage-enterprise-decision-system-portable
----
...
[source]
----
Voyage Enterprise Decision System started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/voyage-enterprise-decision-system/wiki
