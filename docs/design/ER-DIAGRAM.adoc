...
This document defines the core entities and their relationships across
all three data stores. VEDS uses a polyglot persistence strategy with
entities distributed based on query patterns.
