...
Formal verification, advanced analytics, and bitemporal queries are
*deferred to v2*.
...
[width="99%",cols="22%,47%,31%",options="header",]
|===
|DB |Purpose |Data
|*SurrealDB* |Primary store |Network, shipments, routes, constraints,
audit
...
*Deferred to v2:* - Ada/SPARK formal verification - Julia property-based
testing - XTDB Datalog queries
