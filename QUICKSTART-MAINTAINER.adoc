...
// Replace voyage-enterprise-decision-system, {{PACKAGE_NAME}}, {{DEPS}} with actuals
= voyage-enterprise-decision-system — Quick Start for Platform Maintainers
:toc:
:toclevels: 2

== Overview

This guide covers packaging, deploying, and maintaining voyage-enterprise-decision-system for
...
podman build -t voyage-enterprise-decision-system .
----
...
* Upstream: https://github.com/hyperpolymath/voyage-enterprise-decision-system/issues
