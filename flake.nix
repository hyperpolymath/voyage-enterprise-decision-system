{
  description = "voyage-enterprise-decision-system - {project-description}";
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            echo "🚀 voyage-enterprise-decision-system development environment"
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          pname = "voyage-enterprise-decision-system";
          version = "0.1.0";
          src = ./.;
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P voyage-enterprise-decision-system.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/voyage-enterprise-decision-system $out/bin/  # Rust
            # cp bin/voyage-enterprise-decision-system $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/voyage-enterprise-decision-system";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-voyage-enterprise-decision-system" {
